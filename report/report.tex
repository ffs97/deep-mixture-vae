...
\begin{psection}{Experiments}
	...
	Firstly, we show some experiments on VaDE and DMVAE showing reconstruction and generation powers of the models. The datasets we use for these tasks are MNIST \cite{<++>} and spiral dataset. Later, we show the effectiveness of DMVAE over naive gating functions for ME.
...
\begin{table}
	...
	\begin{tabular}{c | l l | l l}
		\bt{Number of Dimensions}	& \bt{Deep MoE}	& \bt{DVMoE}	&	\bt{Deep MoE}	& \bt{DVMoE}\\
		\hline
